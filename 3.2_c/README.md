...
##### Main Light 01
- When `power: "on"`: the light color is white.
- When `power: "off"`: the light color is black-gray (default).

##### Main TV 01
- When `power: "on"`: the TV screen color is white.
- When `power: "off"`: the TV screen color is black-gray (default).

##### Main Roomba 01
- When `power: "on"`: the Roomba color is blue.
- When `power: "off"`: the Roomba color is black-gray (default).
